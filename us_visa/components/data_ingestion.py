...
class DataIngestion:
    ...
    def split_data_as_train_test(self,dataframe:DataFrame)->None:
        ...
        On Failure  :   Write an exception log and then raise an exception
        """
        logging.info("Entering split_data_as_train_test method of Data_Ingestion class")
    ...
    def initiate_data_ingestion(self)-> DataIngestionArtifact:
        ...
        logging.info("Entering initiate_data_ingestion method for Data_Ingestion_class")
        ...
        try:
            ...
            logging.info("Perfom Train Test split on dataset")
